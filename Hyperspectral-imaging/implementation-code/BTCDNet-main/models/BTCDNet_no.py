...
if __name__ == "__main__":
    ...
    model = BTCDNet_no(in_chans=166, num_classes=3, embed_dim=[96, 192], depths=[2, 2], num_heads=[3, 6], n_iter=[1, 1], stoken_size=[2, 1], mlp_ratio=4., qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.1, projection=512, freeze_bn=False, layerscale=[False, False, False, False], init_values=1e-6).to(device)
